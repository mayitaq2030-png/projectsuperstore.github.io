...
-  Strengthen marketing campaigns for high-growth regions and top segments
...
-  Cleaning, structuring, and mapping fields through Excel and data dictionaries.

-  KPI definition: Sales, Profit, Orders, Profit Ratio.

-  Construction of interactive visuals mirroring page-1 dashboard structure (map, bar charts, segment analysis, subcategory ranking).
...
Collaborate with regional sales teams to reinforce pricing discipline and reduce unnecessary discounting that negatively impacts profit ratio.

Add clear messaging in commercial dashboards to highlight margin-sensitive categories and suggest recommended pricing ranges.

Strengthen inventory planning in high-velocity states like California and New York to prevent stockouts and capture full demand.

I believe these adjustments will help reduce margin leakage, improve cross-regional performance, and support revenue growth while saving time for business stakeholders through data self-service.</p>
